...
<form class="mt-4 grid gap-4 sm:grid-cols-2" aria-label="Contact form">
  <div class="sm:col-span-1">
    <label for="name" class="block text-sm font-semibold text-turf-900">Name</label>
    <input id="name" name="name" type="text" autocomplete="name" required class="mt-1 w-full rounded-md border border-turf-300 px-3 py-2" />
  </div>
  <div class="sm:col-span-1">
    <label for="email" class="block text-sm font-semibold text-turf-900">Email</label>
    <input id="email" name="email" type="email" autocomplete="email" required class="mt-1 w-full rounded-md border border-turf-300 px-3 py-2" />
  </div>
  <div class="sm:col-span-1">
    <label for="phone" class="block text-sm font-semibold text-turf-900">Phone</label>
    <input id="phone" name="phone" type="tel" autocomplete="tel" class="mt-1 w-full rounded-md border border-turf-300 px-3 py-2" />
  </div>
  <div class="sm:col-span-1">
    <label for="preferred" class="block text-sm font-semibold text-turf-900">Preferred contact method</label>
    <select id="preferred" name="preferred" class="mt-1 w-full rounded-md border border-turf-300 px-3 py-2">
      <option>Email</option>
      <option>Phone</option>
    </select>
  </div>
  <div class="sm:col-span-2">
    ...
    <textarea id="message" name="message" rows="4" required class="mt-1 w-full rounded-md border border-turf-300 px-3 py-2"></textarea>
  </div>
  <div class="sm:col-span-2">
